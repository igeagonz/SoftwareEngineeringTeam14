 ...
 */
public class BackgroundTaskListCancel extends AsyncTask<EditReservation, Void, ArrayList<String>> {

    Context ctx;
    AlertDialog alertDialog;
    EditReservation editReservation;

    BackgroundTaskListCancel(Context ctx) {
        this.ctx = ctx;
    ...
    protected void onPostExecute(ArrayList<String> result) {
        editReservation.goToMain(result);
    }
}
